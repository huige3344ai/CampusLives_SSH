		...
		<div id="container">
            ...
            <s:else>
				<s:form action="loveActivityAction!addActivity" method="post"
					namespace="/">
					<table align="center" style=" margin-top:155px;margin-left: 75px;">
						<thead align="center">
							<td>
							<td>
								<b>增加活动</b>
                 ...
                 -->
							...
							<tr>
								...
								<td>
									<textarea rows="10" cols="30" name="loveActivity.acContent" value="长度应在300字以内" onFocus="this.value=''" onBlur="if(!value){value=defaultValue;}"></textarea>
								</td>
							</tr>
							<tr>
								<td>

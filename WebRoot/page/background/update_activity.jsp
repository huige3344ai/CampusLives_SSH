     ...
     <div id="container" >
         <div id="header">
			...
			<div class="c_apply">
              ...
              <s:else>
                <% Short name0fForm=1; %>
          <framework   style="margin-top:120px; margin-left:40px;width: 450px; height: 508px; overflow: scroll; position: absolute;" >      
				...
				<table align="center">
						...
						<tbody>
								 ...
								 <s:form namespace="/"  method="post" action="loveActivityAction!updateActivity.action" >
											...
											<s:textarea label="活动内容" rows="10" cols="30" name="loAc.acContent" value="%{#acList.getAcContent()}">
												 
											</s:textarea>
									
									<s:submit cssStyle=" align:left;" value="修改" />
								</s:form>
						</tbody>

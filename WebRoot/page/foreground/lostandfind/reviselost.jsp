...
<s:form action ="lost!lostrevise2.action" method="post"> 
	<s:iterator value="lostlist" var="lost">
<h3>失物名称：<input type = "text" name="lost.lostname" style="width:300px;height:30px;" value="<s:property value="#lost.lostname"/>"/> </h3>
<br>
<br>
<h3>失者姓名：<input type = "text" name="lost.lostername" style="width:300px;height:30px;" value="<s:property value="#lost.lostername"/>"/> </h3>
<br>
<br>
<h3>失物详细信息：（不超过100字）<input type="text" name="lost.description"  style="width: 100%; height: 100px" value="<s:property value="#lost.description"/>"/></h3>
<br>
<br>
<h3>失者地址：<input type = "text" name="lost.address" style="width:100%;height:30px;" value="<s:property value="#lost.address"/>"/> </h3>
<br>
<br>
<h3>失者电话：<input type = "text" name="lost.tel" style="width:300px;height:30px;" value="<s:property value="#lost.tel"/>"/> </h3>
<br>
<br>
<br>
<br><s:hidden name="lost.promulgator" value="%{#session.user.userName}"/>
<s:hidden name="lost.id" value="%{#session.lostid}"/>
<center> 

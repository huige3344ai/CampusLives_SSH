...
<legend align="center" ><h2>失物登记记录</h2></legend>
        ...
        <table align="center" border="1">
           <tbody>
               <tr><td width=40>编号</td><td width=100>失物名称</td>   <td width=260>物品描述</td>   <td width=100>发布者</td><td width=100></td></tr> 
	...
	<tr>
	<td><s:textfield name="lostid" label="编号" style="width:40px;" value="%{#lost.id}" readonly="true"/></td>

...
<html>
 ...
 <div id="contents">               
        <div id="usermessage"> 
        <div id = "headphoto">
        <img src="<s:property value="%{#session.user.imgsrc}"/>"; width:150px; height:150px></div>
...
<s:form action ="find!addfind.action" method="post">
<h3>拾到物名称：<input type = "text" name="find.findname" style="width:300px;height:30px;"/> </h3>
<br>
<br>
<h3>拾到者姓名：<input type = "text" name="find.findername" style="width:300px;height:30px;"/> </h3>
<br>
<br>
<h3>拾到物详细信息：（不超过100字）<input type="text" name="find.description"  style="width: 100%; height: 100px"/></h3>
<br>
<br>
<h3>拾到者地址：<input type = "text" name="find.address" style="width:100%;height:30px;"/> </h3>
<br>
<br>
<h3>拾到者电话：<input type = "text" name="find.tel" style="width:300px;height:30px;"/> </h3>
<br>
<br>
<br>
